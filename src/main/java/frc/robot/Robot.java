...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    goalSpeed = ChassisSpeeds.fromFieldRelativeSpeeds( // This static method generates a new ChassisSpeeds object based on given velocities
      xSlew.calculate(xbox.getRawAxis(XboxController.Axis.kLeftX.value)), // Xbox controller
      ySlew.calculate(xbox.getRawAxis(XboxController.Axis.kLeftY.value)), // Xbox controller
